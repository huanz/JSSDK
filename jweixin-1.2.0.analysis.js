! function (a, b) {
    ...
    function invoke(api, params, callback) {
        window.WeixinJSBridge ? WeixinJSBridge.invoke(api, extendParams(params), function (res) {
    ...
    function extendParams(params) {
        ...
        params.verifyAppId = wxConfig.verifyAppId;
        params.verifySignType = 'sha1';
        params.verifyTimestamp = wxConfig.timestamp + '';
        params.verifyNonceStr = wxConfig.nonceStr;
        params.verifySignature = wxConfig.signature;
